...
export const CHECKLIST_ITEMS: ChecklistItemDef[] = [
  ...
  { id: 14, category: 'KINH DOANH', title: 'Hoạt động offline trong ngày', placeholder: 'Nêu các HĐ offline, event diễn ra tại địa điểm', example: 'Có band nhạc acoustic, Giao lưu fan club' },
  { id: 15, category: 'KINH DOANH', title: 'CX Team', placeholder: 'Nhập tên nv Cx và thời gian lv tại điểm', example: 'Ly có mặt tại CH từ 17h - 21h' },
  { id: 16, category: 'KINH DOANH', title: 'Tổng Bar', placeholder: 'Nhập tên Tổng bar và thời gian lv tại điểm', example: 'Lâm có mặt tại CH từ 17h - 21h' },
  { id: 17, category: 'KINH DOANH', title: 'Xuất bán khách tiệc', placeholder: 'Ghi đơn bán khách tiệc phát sinh trong ngày', example: '2 bom 50l' },
  { id: 18, category: 'KINH DOANH', title: 'Số lượng Thành viên tích điểm/ tổng bill', placeholder: 'Ghi số lượng thành viên tích điểm trong ngày / tổng số bill bán trong ngày', example: '15/50 bill' },
  { id: 19, category: 'KINH DOANH', title: 'Phát sinh bất thường trong ngày', placeholder: 'Ghi các bất thường trong ngày', example: 'Công an đến thu biển. KH say ngã ở toilet... Đông khách đột biến nên thiếu nhân sự bếp nên đồ ra lâu' },
  { id: 20, category: 'KINH DOANH', title: 'Đề xuất', placeholder: 'Nêu ý kiến cải tiến, đề xuất, hiện trạng', example: 'Bổ sung thêm 8 ghế và 5 bàn' },
];